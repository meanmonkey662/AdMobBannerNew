...
public class MyActivity extends ActionBarActivity
{
    ...
    /**
     * This below creates a math.random that picks a random color for the button and the background.
     */
    ...
    /**
     * This sets the listener for the colorButton that changes the color of the button and background
     */
